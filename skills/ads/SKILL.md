---
name: ads
description: "End-to-end paid advertising skill for Claude Code: strategy generation, copy production, multi-platform audit, and client-ready reporting. Orchestrates 29 specialized sub-skills and 15 agents across Google, Meta, YouTube, LinkedIn, TikTok, Microsoft, and Apple Ads. 250+ weighted checks, 11 industry templates, 5-agent parallel strategy builds, PDF reports, and AI creative generation."
argument-hint: "strategy <url> | quick <url> | audience <url> | copy <platform> | hooks | video <product> | creative-brief <product> | creative-audit | funnel <url> | budget [amount] | keywords <url> | testing <campaign> | landing <url> | plan <industry> | competitor <url> | report-pdf | audit | google | meta | youtube | linkedin | tiktok | microsoft | apple | dna <url> | create | generate | photoshoot | math | test | help"
license: MIT
---
...
|---------|--------------|
| `/ads strategy <url>` | Flagship: 5-agent parallel strategy build with Ad Readiness Score (0-100). Full report. |
...
This skill orchestrates 29 specialized sub-skills grouped by purpose.
